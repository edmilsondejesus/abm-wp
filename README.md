...
2 -Open the GAMA platform, import the model <models\ABMS-WP_Framework.gaml> and files from the <includes> folder, and run the model in GAMA. Ensure that the variable `<data_reference_year>` is set to 2015.
...
2 - After that, open the GAMA platform, import model `<models\ABMS-WP_Framework.gaml>` and files from the `<includes>` folder, and run the model in GAMA. Make sure the <data_reference_year> variable is set to 2025.
